  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 flex flex-col items-center">
      <div className="w-full max-w-lg bg-white rounded-[2.5rem] shadow-2xl overflow-hidden border border-white">
        <div className="bg-gradient-to-br from-orange-500 to-pink-500 p-10 text-center text-white">
          <h1 className="text-3xl font-black tracking-tighter text-white">GOURMET LOG</h1>
          <p className="text-orange-100 text-[10px] font-bold uppercase tracking-[0.3em] mt-2">API Key Updated</p>
        </div>

        <form onSubmit={handleSubmit} className="p-8 space-y-6">
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1 text-black">Shop Name</label>
            <input
              type="text"
          ...
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1 text-black">Tags</label>
          ...
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1 text-black">Rating</label>
            <select 
          ...
          <div>
            <label className="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2 ml-1 text-black">Comment</label>
            <textarea
          ...
          <button 
            ...
            className={`w-full py-5 rounded-2xl font-black text-white shadow-lg transition-all ${
              loading ? 'bg-slate-300' : 'bg-orange-500 hover:bg-orange-600 active:scale-95'
            }`}
          >
